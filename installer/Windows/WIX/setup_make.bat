...
light.exe -ext WixNetFxExtension.dll -ext WixUtilExtension.dll -loc "English-US.wxl" -out "../build/setup.msi" -b "%PathToFile%/Tomcat_Server/webapps" "../build/webapps.wixobj" "../build/setup.wixobj" "../build/UserInterface.wixobj" "../build/Common.wixobj" "../build/ErrorText.wixobj" "../build/ProgressText.wixobj" 
if ERRORLEVEL 1 goto error
