...
import com.solarflare.vcp.services.ChassisDataAdapter;
import com.solarflare.vcp.services.ChassisService;
// [end-chassis-code]
...
public class ActionsController {
   ...
   // Empty controller to avoid warnings in solarflare-ui's bundle-context.xml
   ...
   public Map<String, Object> invoke(
      ...
      // [removable-chassis-code]
      if (actionUid.equals("com.solarflare.vcp.editChassis") ||
            actionUid.equals("com.solarflare.vcp.deleteChassis") ||
            actionUid.equals("com.solarflare.vcp.createChassis")) {
      ...
      if (actionUid.equals("com.solarflare.vcp.sampleAction1")) {
      ...
      } else if (actionUid.equals("com.solarflare.vcp.sampleAction2")) {
   ...
   private Map<String, Object> handleChassisActions(String actionUid, URI objectRef, String json)
      ...
      } else if (actionUid.equals("com.solarflare.vcp.createChassis")) {
