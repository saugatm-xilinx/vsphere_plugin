...
public class NicBootParamInfo
{
    ...
    {
        return "NicBootParamInfo [bootImage=" + bootImage + ", linkSpeed=" + linkSpeed + ", linkUpDelayTime=" + linkUpDelayTime
                + ", bannerDelayTime=" + bannerDelayTime + ", bootSkipDelayTime=" + bootSkipDelayTime + ", bootType=" + bootType
                + ", physicalFunPerPort=" + physicalFunPerPort + ", msiXinterruptLimit=" + msiXinterruptLimit
                + ", numOfVirtualFunctions=" + numOfVirtualFunctions + ", firmwareVariant=" + firmwareVariant
                + ", insecureFilters=" + insecureFilters + ", vLANTags=" + vLANTags + ", switchMode=" + switchMode + "]";
    }
