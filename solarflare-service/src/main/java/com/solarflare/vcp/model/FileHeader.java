...
public class FileHeader {
	...
	public String toString() {
		return "FileHeader [version=" + version + ", type=" + type + ", subtype=" + subtype + ", codeVersion_a="
				+ codeVersion_a + ", codeVersion_b=" + codeVersion_b + ", codeVersion_c=" + codeVersion_c
				+ ", codeVersion_d=" + codeVersion_d + "]";
	}
