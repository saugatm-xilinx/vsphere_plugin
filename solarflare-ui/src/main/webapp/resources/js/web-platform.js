...
// This also creates the plugin's private namespace com_msys_solarflare
//
...
var com_msys_solarflare;
if (!com_msys_solarflare) {
   com_msys_solarflare = {};

   // The web context path to use for server requests, compatible with Flex and HTML clients
   com_msys_solarflare.webContextPath = WEB_PLATFORM.getRootPath() + "/solarflare";
   ...
   (function () {
      ...
      // Functions exported to the com_msys_solarflare namespace
